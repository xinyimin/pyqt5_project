...
"font :32pt \"黑体\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(60, 220, 261, 81))
...
"}")
    ...
    def retranslateUi(self, LoginWindow):
        ...
        self.label.setText(_translate("LoginWindow", "欢迎登录"))
        self.label_2.setText(_translate("LoginWindow", "第一次制作的登录界面"))
